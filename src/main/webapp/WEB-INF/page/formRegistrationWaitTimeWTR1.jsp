...
<fieldset id="fs1" data-dojo-id="fs1" dojoType="dijit.Fieldset" title="Registration Wait Time (WTR1)">
<c:url value="/registrationWaitTimeWTR1" var="url"></c:url>
        ...
        <td><label class="formLabel"> View Selection:</label></td>
         <td colspan="3">
            ...
            <select name="viewSelection" id="viewSelection"  data-dojo-type="dijit/form/Select" style="width:200px">
               <option value="1" selected="selected"> By Service Location  </option>                   
               <option value="2"> By Service Area  </option> 
               <option value="3"> By Patient's Visit View   </option> 
