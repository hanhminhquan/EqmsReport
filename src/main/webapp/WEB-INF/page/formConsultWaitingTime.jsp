...
<fieldset id="fs1" data-dojo-id="fs1" dojoType="dijit.Fieldset" title="MOH SOC Consult Waiting Time">
<c:url value="/consultWaitingTime" var="url"></c:url>
<input type="hidden" name="pathServer" id="pathServer" value="<%= request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()  +request.getContextPath() %>"> 
   ...
   <tr> 
         <td><label class="formLabel"> Date:</label></td>       
         <td><input type="text" id="serviceDate" name=""serviceDate"" constraints="{datePattern:'dd-MM-yyyy'}" value="${curentDate}" style="width:110px" data-dojo-type="dijit/form/DateTextBox"  /></td>  
          <td><label class="formLabel"> Service Time From:</label></td>       
         <td><input type="text" id="startDate" name="startDate" style="width:90px" data-dojo-type="dijit/form/TimeTextBox"  /></td>  
         <td><label class="formLabel"> Service Time To:</label></td>
         <td><input type="text" id="endDate" name="endDate"  style="width:90px" data-dojo-type="dijit/form/TimeTextBox"  />       
     </tr>
