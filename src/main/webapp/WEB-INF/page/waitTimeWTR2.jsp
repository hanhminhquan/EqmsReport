...
<head>   
  ...
  <script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/report/waitTimeWTR2.js"></script>
...
<body class="claro">
    ...
    <div data-dojo-type="dijit/layout/BorderContainer" id="main">
        <div id="header" data-dojo-type="dijit/MenuBar" data-dojo-props="region:'top'">
         ...
         <div data-dojo-type="dijit/layout/ContentPane" data-dojo-props="region:'top'"><%@ include file="/../WEB-INF/page/formWaitTimeWTR2.jsp"%>
